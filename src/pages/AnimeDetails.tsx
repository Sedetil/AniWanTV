              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="flex gap-2">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="h-6 bg-muted-foreground/20 rounded w-16" />
                    ))}
                  </div>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 pt-24">
          <div className="container mx-auto px-4 py-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">We couldn't load the details for this anime. Please try again later.</p>
            <Link to="/">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {data.genres.map((genre) => (
                        <Badge key={genre} variant="secondary" className="bg-muted hover:bg-muted/80">
                          {genre}
                        </Badge>
                      ))}
                    </div>
